...
from release_pipeline5ab.ab6_partfieldloss_sizeaug_decoder_bbox.data import TrainingData, EvalData, collate_fn
from release_pipeline5ab.ab6_partfieldloss_sizeaug_decoder_bbox.mixdecodernet import PointSemSegWithbboxDecoder  # PointSemSegWithDecoder, 
from release_pipeline5ab.ab6_partfieldloss_sizeaug_decoder_bbox.mixdecoderloss import BalancedMaskCrossEntropyLoss, PointBasedBBoxOffsetLoss
...
def train(rank, world_size, args):
    ...
    for epoch in range(start_epoch, args.n_epoch + 1):
        ...
        for iter_idx, data in enumerate(train_iterator):
            ...
            backbone_feat, decoder_out, decoder_offset, bbox_pred, bbox_offset = model(data)

            # # debug
            # print('coord', data['coord'].shape)
            # print('pt_offset:', pt_offset.shape)
            # print('mask_points:', len(mask_points))
            ...
            # 计算总损失
            total_loss = baseline_loss + weighted_decoder_loss + weighted_bbox_loss
