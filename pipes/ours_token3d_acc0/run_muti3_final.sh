...
CUDA_VISIBLE_DEVICES=$gpuID /x2robot_v2/lanejin/new_data/miniforge3/envs/find3d/bin/python -m pipes.ours_token3d_acc.train_mutigpus \
    ...
    --prefetch_factor 2 2>&1 | tee "$log_file"
    # --batch_size=32
