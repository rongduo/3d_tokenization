...
def prep_points_train(xyz, rgb, normal, mask2pt, canoncial_color=None):
    ...
    data_dict = {"coord": xyz_change_axis, "color": rgb, "normal":normal, "mask2pt": mask2pt, 'canoncial_color': canoncial_color}
    ...
    if canoncial_color is not None:
        data_dict = Collect(keys=('coord', 'grid_coord', 'mask2pt', 'canoncial_color'),
...
class TrainingData(Dataset):
    ...
    def __getitem__(self, item):
        ...
        # print('canoncial_color:', canoncial_color)

        
        point_dict = prep_points_train(pts_xyz.numpy(), pts_rgb.numpy(), normal.numpy(), mask_pts.numpy(), canoncial_color.numpy())
