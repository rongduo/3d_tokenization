...
def main():
    ...
    input_path = "/apdcephfs_cq11/share_303570626/lanejin/dataset/3dcompat200/forfind3dtest/airplane/coarse_b'00_004'/points.pt"
    ...
    save_path = os.path.join(save_dir, f"{input_filename}_colored.ply")
