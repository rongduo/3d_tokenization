...
from release_pipeline5ab.ab6_partfieldloss_sizeaug_decoder_bbox.mixdecoderloss import PointBasedBBoxOffsetLoss
...
def setup(rank, world_size):
    ...
    os.environ['MASTER_PORT'] = '12345'  # '12355'
...
def train(rank, world_size, args):
    ...
    for epoch in range(start_epoch, args.n_epoch + 1):
        ...
        for iter_idx, data in enumerate(train_iterator):
            ...
            # 计算总损失
            total_loss = baseline_loss + weighted_decoder_loss + weighted_canoncolor_loss + weighted_bbox_loss
