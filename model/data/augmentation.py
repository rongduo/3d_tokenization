...
class GridSample(object):
    ...
    def __call__(self, data_dict):
        ...
        if self.mode == "train":  # train mode
            ...
            if "partfieldfeats" in data_dict.keys():
                data_dict["partfieldfeats"] = data_dict["partfieldfeats"][idx_unique]
            if "canoncial_color" in data_dict.keys():
                data_dict["canoncial_color"] = data_dict["canoncial_color"][idx_unique]
